<%@ Page Title="" Language="C#" MasterPageFile="../Web.Master" AutoEventWireup="true" CodeBehind="AssyMachines.aspx.cs" Inherits="PlantControl.Views.AssyMachines" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div>
        <asp:GridView CssClass="AssyMachinepageGridView" Style="margin-bottom: 60px;"
            ...
            ID="AssyIDResults" runat="server" AutoGenerateColumns="false" AllowPaging="true"
