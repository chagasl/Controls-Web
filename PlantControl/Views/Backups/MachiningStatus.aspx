<%@ Page Title="" Language="C#" MasterPageFile="../Web.Master" AutoEventWireup="true" CodeBehind="MachiningStatus.aspx.cs" Inherits="PlantControl.Views.MachiningStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div>
        <asp:GridView CssClass="LinesBackupsStatusGridView" Style="margin-bottom: 60px;"
            ...
            ID="MachiningResults" runat="server" AutoGenerateColumns="false" AllowPaging="true"
            AllowSorting="true" PageSize="300">
            <Columns>
                <asp:BoundField DataField="CELL" HeaderText="MACHINING LINE" ItemStyle-Wrap="false"></asp:BoundField>
