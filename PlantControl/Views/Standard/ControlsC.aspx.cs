...
{
    public partial class ControlsC : System.Web.UI.Page
    {
        private static string pathServer = @"\\xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            bool authorizated = masterPage.DefineUserRights(role, "ControlsC");
            if (!authorizated)
            {
        ...
        protected void btnCLP_ServerClick(object sender, EventArgs e)
        {
            BindDataGridView("PLC");
            id05.Style.Add("display", "block");
            labelType.InnerText = "PLC";
        }

        protected void btnIHM_ServerClick(object sender, EventArgs e)
        {
            BindDataGridView("IHM");
            id05.Style.Add("display", "block");
            labelType.InnerText = "IHM";
        }

        protected void btnRobots_ServerClick(object sender, EventArgs e)
        {
            BindDataGridView("ROBOTS");
            id05.Style.Add("display", "block");
            labelType.InnerText = "ROBOTS";
        }
        ...
        protected void btnESM_ServerClick(object sender, EventArgs e)
        {
            ...
            id05.Style.Add("display", "block");
            labelType.InnerText = "ESM C";
        }

        protected void btnDrawings_ServerClick(object sender, EventArgs e)
        {
            BindDataGridView("DRAWINGS");
            id05.Style.Add("display", "block");
            labelType.InnerText = "DRAWINGS";
        }

        protected void btnHardware_ServerClick(object sender, EventArgs e)
        {
            BindDataGridView("HARDWARE");
            id05.Style.Add("display", "block");
            labelType.InnerText = "HARDWARE";
        }
